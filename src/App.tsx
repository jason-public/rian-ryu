...
export default function App() {
  return (
    <div className="min-h-screen bg-[#EEEFEA] text-[#141414] font-sans selection:bg-[#141414] selection:text-[#EEEFEA]">
      {/* Header */}
      <header className="fixed w-full top-0 z-50 border-b border-[#141414] bg-[#EEEFEA]/90 backdrop-blur-sm px-6 h-16 flex items-center justify-between text-xs font-bold uppercase tracking-widest">
      ...
      <main className="pt-16">
        {/* HERO SECTION */}
        <section className="relative min-h-[85vh] flex flex-col justify-end p-6 md:p-12 border-b border-[#141414] pb-12 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none select-none">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#EEEFEA] via-[#EEEFEA]/60 to-transparent z-10" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#EEEFEA] via-[#EEEFEA]/40 to-transparent z-10" />
          ...
          <div className="grid md:grid-cols-12 gap-12 items-end relative z-30">
             <div className="md:col-span-8 overflow-hidden">
               ...
               >
                 Public<br />Admin<span className="text-transparent" style={{ WebkitTextStroke: '2px #141414' }}>istrator</span>
               </motion.h1>
             </div>
             <div className="md:col-span-4 pb-2">
               ...
               >
                 <div className="w-12 h-[2px] bg-[#141414] mb-6" />
        ...
        {/* HIGHLIGHTS SECTION */}
        <section id="work" className="border-b border-[#141414]">
            ...
            <div className="md:col-span-9 flex flex-col">
               {highlights.map((item, idx) => (
                 <div 
                   ...
                   className="group border-b border-[#141414] last:border-0 p-6 md:p-12 grid md:grid-cols-12 gap-8 items-center cursor-pointer hover:bg-[#141414] hover:text-[#EEEFEA] transition-all duration-300"
                 >
                    ...
                    <div className="md:col-span-7">
                      <h3 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight group-hover:text-[#EEEFEA]">{item.title}</h3>
                      <p className="text-sm opacity-60 leading-relaxed break-keep group-hover:opacity-80">{item.description}</p>
                    </div>
                    <div className="md:col-span-2 flex justify-start md:justify-end">
                      <div className="w-12 h-12 rounded-full border border-current flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all -translate-x-4 group-hover:translate-x-0 group-hover:bg-white group-hover:text-[#141414]">
        ...
        <section className="grid lg:grid-cols-2">
          ...
          <div id="experience" className="border-r border-b lg:border-b-0 border-[#141414]">
            ...
            <div className="p-6 md:p-12 space-y-16">
               {experience.map((exp, idx) => (
                 <div key={idx} className="relative pl-8 border-l border-[#141414]">
                   <div className="absolute w-2 h-2 bg-[#141414] -left-[4.5px] top-2 rounded-full" />
                   ...
                   <div className="text-xs font-bold uppercase tracking-widest mb-6 border border-[#141414] w-max px-3 py-1.5 rounded-full">
                     {exp.organization}
                   </div>
          ...
          <div>
            ...
            <div className="p-6 md:p-12 border-b border-[#141414]">
              <h3 className="text-xs font-bold uppercase tracking-widest mb-10 opacity-50 border-b border-[#141414]/20 pb-4">Awards</h3>
            ...
            <div className="p-6 md:p-12 border-b border-[#141414] bg-white">
              <h3 className="text-xs font-bold uppercase tracking-widest mb-10 opacity-50 border-b border-[#141414]/20 pb-4">Media Coverage</h3>
              <div className="space-y-8">
            ...
            <div className="p-6 md:p-12 bg-white">
              <h3 className="text-xs font-bold uppercase tracking-widest mb-10 opacity-50 border-b border-[#141414]/20 pb-4">AI Expertise</h3>
              <div className="space-y-8">
        ...
        {/* FOOTER */}
        <footer id="about" className="p-6 md:p-12 bg-[#141414] text-[#EEEFEA] flex flex-col justify-center text-center min-h-[50vh] border-t border-[#141414] relative overflow-hidden">
          ...
          <div className="w-12 h-px bg-white/20 mx-auto mb-10 relative z-10" />
